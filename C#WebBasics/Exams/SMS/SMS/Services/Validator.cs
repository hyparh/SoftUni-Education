...
namespace SMS.Services
{
    ...
    public class Validator : IValidator
    {
        ...
        public ICollection<string> ValidateProduct(CreateProductFormModel model)
        {
            ...
            if (model.Name == null || model.Name.Length < ProductMinLength || model.Name.Length > ProductMaxLength)
            {
                errors.Add($"Product name must be between {ProductMinLength} and {ProductMaxLength} characters long.");
            }
